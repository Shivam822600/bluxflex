    ...
    <Layout>
      ...
      <section style={{ background: 'linear-gradient(135deg, #072834 0%, #0F3A4A 100%)', color: '#FFFFFF', padding: 'clamp(44px, 6vw, 64px) 0' }}>
        <div className="container">
          ...
          <p style={{ color: '#94A3B8', fontSize: '15.5px', maxWidth: '840px', lineHeight: '1.6', marginBottom: '28px' }}>
          ...
          <div style={{ display: 'flex', gap: '14px', flexWrap: 'wrap' }}>
            ...
            <a
              ...
              style={{ padding: '14px 24px', fontSize: '14.5px', fontWeight: '700', borderColor: 'rgba(255,255,255,0.3)', color: '#FFFFFF' }}
            >
      ...
      <section style={{ padding: 'clamp(36px, 6vw, 64px) 0', background: '#F8FAFC', borderTop: '1px solid #E2E8F0' }}>
        <div className="container">
          <div style={{
            ...
            <div style={{ background: '#FFFFFF', borderRadius: '24px', padding: 'clamp(18px, 3.5vw, 32px)', textAlign: 'center', border: '1px solid #EEF2F6', boxShadow: '0 10px 30px rgba(0,0,0,0.04)' }}>
              <img src={asset_image0_1_1024x683_png_2} alt="Printed Paper Roll Stock for Form & Fill Systems" style={{ maxHeight: '300px', width: '100%', objectFit: 'contain', margin: '0 auto' }} />
            </div>
            ...
            <div>
              ...
              <p style={{ color: '#475569', fontSize: '14.5px', lineHeight: '1.7', marginBottom: '20px' }}>
                BulkFlex supplies <strong>Canadian-manufactured printed paper roll stock</strong> designed for high-speed form and fill packaging lines. Our materials ensure consistent print quality, reliable performance, and efficient automated production.
              </p>
              ...
              <p style={{ fontSize: '13.5px', color: '#475569', lineHeight: '1.6', background: '#FFFFFF', padding: '16px 20px', borderRadius: '12px', border: '1px solid #E2E8F0' }}>
        ...
        <div className="container">
          <div style={{
            ...
            <h2 style={{ fontSize: 'clamp(22px, 3.5vw, 32px)', color: '#FFFFFF', fontWeight: '800', marginBottom: '12px' }}>
              High-Speed Multiwall Paper Packaging Orders
            </h2>
