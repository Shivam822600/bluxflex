...
import asset_jute_sacks_png_1 from '../assets/images/official/jute_sacks.png?url';

export default function ProductJuteSacks() {
    useEffect(() => {
    ...
    return (
        <Layout>
            <div dangerouslySetInnerHTML={{ __html: `<main id="content" class="site-main post-1292 product type-product status-publish has-post-thumbnail hentry product_category-jute-burlap">
