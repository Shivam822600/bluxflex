...
export default function ProductCategoryDiaperBagFeed() {
    useEffect(() => {
...
<channel>
	<title>Diaper Bag Archives - Bulk Flex Private Limited</title>
	<atom:link href="/product_category/diaper-bag/feed/" rel="self" type="application/rss+xml">
	<link>/product_category/diaper-bag/
