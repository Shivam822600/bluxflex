...
import asset_cooler_bags_jpg_1 from '../assets/images/official/cooler_bags.jpeg?url';
import asset_cooler_bags_jpeg_2 from '../assets/images/official/cooler_bags.jpeg?url';
...
export default function ProductCoolerBags() {
	...
	<div class="productDetailsWrapper">
        ...
        <p>A cooler bag helps keep perishable purchases at a safe temperature on the way home. For grocery, specialty food, beverage, meal kit, and pharmaceutical retail, it serves both a functional purpose and a branding opportunity — a well-made branded cooler bag that a customer keeps and reuses provides repeat brand exposure on future trips.</p>
