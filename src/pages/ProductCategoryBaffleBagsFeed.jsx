...
export default function ProductCategoryBaffleBagsFeed() {
    useEffect(() => {
...
<channel>
	<title>Baffle Bags Archives - Bulk Flex Private Limited</title>
	<atom:link href="/product_category/baffle-bags/feed/" rel="self" type="application/rss+xml">
	<link>/product_category/baffle-bags/
