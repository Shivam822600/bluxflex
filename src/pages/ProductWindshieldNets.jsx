...
export default function ProductWindshieldNets() {
	...
	<div class="productDetailsWrapper">
        ...
        <p><em>Detailed specifications for Windshield Nets are being finalized and will be added shortly. Contact our team for current product information, availability, and pricing.</em></p>
